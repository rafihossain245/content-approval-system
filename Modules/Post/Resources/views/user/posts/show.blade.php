    ...
    >
        ...
        <div class="row mt-4">
            <div class="col-12 col-sm-8">
                <x-user.section-show-table :data="$$module_name_singular" :module_name="$module_name" />
            </div>
            <div class="col-12 col-sm-4">
                ...
                <ul>
                    <li>
                        <a
                            href="{{ route("user.categories.show", [$$module_name_singular->category_id, $$module_name_singular->category->slug]) }}"
                        >
                ...
                <ul>
                    @foreach ($$module_name_singular->tags as $tag)
                        <li>
                            <a href="{{ route("user.tags.show", [$tag->id, $tag->slug]) }}">
                                {{ $tag->name }}
                            </a>
                        </li>
                    @endforeach
